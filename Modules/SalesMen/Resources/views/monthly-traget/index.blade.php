        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ url('sr-monthly-target/add') }}" class="btn btn-primary btn-sm font-weight-bolder"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        @else
                        <x-form.selectbox labelName="Warehouse" name="warehouse_id" required="required" col="col-md-3" class="selectpicker" onchange="getSalesmenList()">
...
@include('salesmen::monthly-traget.modal')
@endsection
...
$(document).ready(function(){
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('sr.monthly.target.bulk.delete')}}";
...
function getSalesmenList(warehouse_id)
{
    $.ajax({
        ...
        dataType:"JSON",
        success:function(data){
            let salesman = `<option value="">Select Please</option>`;
            $.each(data, function(key, value) {
                salesman += '<option value="'+ key +'">'+ value +'</option>';
            });
            $('#form-filter #salesmen_id').empty().append(html);
            $('#form-filter #salesmen_id .selectpicker').selectpicker('refresh');
        },
    });
}
